...
- This AO/Codex session is the worker that must execute the work request directly. Do not invoke the AO CLI, spawn a nested AO worker/session, or delegate the same implementation task back through Bridge unless the work request explicitly requires multi-agent delegation.
